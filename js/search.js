...
function search() {
    ...
    const headings = document.querySelectorAll('.searchable');
    const matches = [];
...
function showOptions(matches) {
    ...
    matches.forEach(match => {
        ...
        li.textContent = document.querySelectorAll('.searchable')[match.index].textContent;
...
function scrollToElement(index) {
    const targetElement = document.querySelectorAll('.searchable')[index];
